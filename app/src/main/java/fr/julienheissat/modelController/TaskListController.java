...
public class TaskListController
{
    ...
    private PriorityListController priorityListController;
    ...
    public TaskListController(SQLiteDatabase database)
    {
        ...
        projectListController = new ProjectListController(database);


        priorityListController = new PriorityListController(database);
    ...
    private void loadTasks()
    {
        ...
        if (!tasksCursor.isAfterLast())
        {
            do
            {
                ...
                Long projectId = tasksCursor.getLong(6);
                Project project = this.projectListController.getProjectById(projectId);

                Long priorityId = tasksCursor.getLong(7);
                Priority priority = this.priorityListController.getPriorityById(priorityId);
    ...
    public void addTask(Task t)
    {
        ...
        values.put(TASK_PROJECT,t.getProject().getProjectID());
        values.put(TASK_PRIORITY,t.getPriority().getPriorityId());
    ...
    public PriorityListController getPriorityListController() {
        return priorityListController;
    }

    public void setPriorityListController(PriorityListController priorityListController) {
        this.priorityListController = priorityListController;
    }
}
