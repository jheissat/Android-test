...
public class AddTaskActivity extends ActionBarActivity
{
    ...
    public void setupSpinners() {
        ...
        taskProjectSpinner.setAdapter(new ProjectListAdapter(this,R.layout.item_project_list,getTaskManagerApplication().getTaskListController().getProjectListController().getProjectList()));
        ...
        taskProjectSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                String project = taskProjectSpinner.getSelectedItem().toString();
                if (project != "Project:")
                {
                    t.setProject(getTaskManagerApplication().getTaskListController().getProjectListController().getProjectByName(project));
                }
        ...
        taskPrioritySpinner.setAdapter(new PriorityListAdapter(this,R.layout.item_priority_list,getTaskManagerApplication().getTaskListController().getPriorityListController().getPriorityList()));
        taskPrioritySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                {
                    t.setPriority(getTaskManagerApplication().getTaskListController().getPriorityListController().getPriorityByName(priority));
                }
            }
